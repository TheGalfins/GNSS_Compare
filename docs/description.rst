...
The purpose of GNSS Compare is to make the life of developers and reasearchers easier. It's an easy to use and easy to extend framework for calculating the PVT (:ref:`pvt`).
